...
do
  ...
  #echo "$test"
  git clone --mirror https://$BB_USERNAME:$BB_PASSWORD@bitbucket.org/$bb_org/$bb_repo.git
  cd $bb_repo.git
  echo
  ...
  git push --mirror https://$GH_USERNAME:$GH_PASSWORD@github.com/$gh_org/$gh_repo.git
  echo
